#!/usr/bin/env ruby
# validator from https://blog.picnic.nl/how-to-use-yaml-schema-to-validate-your-yaml-files-c82c049c2097

require './schema/Rx.rb' # Taken from the Rx repository, see https://github.com/rjbs/Rx/blob/master/ruby/Rx.rb
require 'yaml'
...
# puts "Validating"
puts "Validating character sheet data"
if schema then
  begin  
    schema.check!(validatable)
    # puts "  ✅  File is according to schema."
    puts "  ✅  Character sheet is valid (meets schema requirements)."
  rescue Exception => e
